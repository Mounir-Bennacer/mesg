...
@section('title','Chargé d\'affaires')
								...
								<form class="kt-form kt-form--label-right">
									<div class="kt-portlet__body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<select class="form-control form-control--fixed kt-selectpicker" multiple data-max-options="2" data-width="200">
													<option>Mustard</option>
													<option>Ketchup</option>
													<option>Relish</option>
												</select>
										...
										<div class="form-group row">
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<select class="form-control kt-selectpicker">
													<option data-content="<span class='kt-badge kt-badge--success kt-badge--inline kt-badge--rounded'>Relish</span>">Mustard</option>
													<option data-content="<span class='kt-badge kt-badge--warning kt-badge--inline kt-badge--rounded'>Ketchup</span>">Ketchup</option>
													<option data-content="<span class='kt-badge kt-badge--brand kt-badge--inline kt-badge--rounded'>Relish</span>">Relish</option>
													<option data-content="<span class='kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded'>Chili</span>">Chili</option>
												</select>
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<a href="" class="btn btn-success kt-btn kt-btn--pill" data-toggle="modal" data-target="#kt_select_modal">Launch modal examples</a>
											</div>
										</div>
									</div>
